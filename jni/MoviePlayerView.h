...
private:
	...
	friend void		ApplyVideoCallback( UITextButton *button, void *object );
	...
	friend bool		ApplyVideoIsEnabledCallback( UITextButton *button, void *object );
